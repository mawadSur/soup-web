import { LASTEST_DONATIONS } from '@/constant'

export default function LastestDonations() {
  return (
    <section className="py-10 sm:py-10 lg:pb-24 lg:pt-0">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {LASTEST_DONATIONS.map((donation) => (
              ...
              <div className="bg-white rounded-lg shadow-lg p-4">
                <div className="flex mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="text">
                      <p>Donated <span className="font-bold text-green-500">{donation.amount}</span> for</p>
