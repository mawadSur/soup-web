    ...
    <nav ref={navRef} className="w-full bg-black text-white z-50">
      <div className="relative mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div
          ...
          className={cn(
            "lg:block absolute lg:relative top-full lg:top-auto left-0 lg:left-auto z-20",
              ...
              >
                <Link
                  ...
                  className={cn(
                    ...
                    item.href === pathName ? "text-red-500 font-bold" : "hover:text-red-300 text-white focus:text-red-300"
                  )}
                >
                  {item.label}
                </Link>
