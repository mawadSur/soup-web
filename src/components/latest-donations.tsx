      ...
      <div className="flex justify-center mb-12">
        <div className="text-center md:w-7/12">
          ...
          <p className="text-black text-lg font-normal">
            See the impact of our generous donors supporting various causes.
          </p>
        </div>
      </div>
              ...
              <div className="flex mb-4">
                ...
                <div className="ml-4">
                  <h3 className="text-lg text-black font-normal">
                    <Link target="_blank" href={DONATION_URL}>
                      {donation.name}
                    </Link>
                  </h3>
                  <time dateTime={donation.timestamp} className="block text-xs text-black/30 mb-2 mt-0.5">
                    {formatRelativeTime(donation.timestamp)}
                  </time>
                  <div className="text">
                    <p>
                      Donated <span className="font-bold text-green-500">{formatNumber(donation.amount)}</span> for
                    </p>
                    <p>
                      <Link
                        target="_blank"
                        href={DONATION_URL}
                        className="inline-block text-color1 text-xs mt-1 underline"
                      >
                        {donation.cause}
                      </Link>
                    </p>
